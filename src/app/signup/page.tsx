      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-md mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Join thousands styling with AI</p>
          </div>
          ...
          <div className="bg-gray-800/50 border border-gray-700 rounded-3xl p-8 backdrop-blur-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-start space-x-3">
                <input
                  ...
                  id="terms"
                  required
                  className="mt-1 w-4 h-4 bg-gray-700 border border-gray-600 rounded focus:ring-purple-500 focus:ring-2"
                />
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-400">
                ...
                <Link href="/login" className="text-purple-400 hover:text-purple-300 transition-colors duration-200 font-medium">
                  Sign in here
                </Link>
              </p>
            </div>
